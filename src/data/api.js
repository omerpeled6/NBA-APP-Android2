...
const removeFromBasket = async (
  ...
  try {
    ...
    setPrice((prevPrice) => prevPrice - player.price); // Update the price context
    setCountPlayer((prevCount) => prevCount - 1); // Update the count context
  } catch (error) {
...
/************************************ Add Basket ************************************/
const addToBasket = async (user, player, setPrice, setCountPlayer) => {
  if (!user || !player) {
    console.error('User or player data is missing');
...
/************************************ Create DreamTeam ************************************/
const createDreamTeam = async (user, playerIds, setPrice, setCountPlayer) => {
  if (!user || !playerIds) {
  ...
  try {
    ...
    setPrice(0); // Update the price context
    setCountPlayer(0); // Update the count context
